                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-info">
                                    ...
                                    <p class="card-category">Inventarios registrados</p>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-12 text-right">
                                                <a href="{{ route('inventario.create') }}"
                                                    class="btn btn-sm btn-facebook">Añadir Inventario</a>
                                        </div>
                                    </div>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="td-actions text-right">
                                                                ...
                                                                <form
                                                                    ...
                                                                    @csrf
                                                                    @method('delete')
                                                                    <button class="btn btn-danger" style="background: #ef4444" type="submit" rel="tooltip">
